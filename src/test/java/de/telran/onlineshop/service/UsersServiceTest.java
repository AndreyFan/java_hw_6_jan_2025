...
class UsersServiceTest {
    ...
    @Test
    void initUsers() {
        when(cartsRepositoryMock.save(any(CartEntity.class))).thenReturn(new CartEntity());
        when(usersRepositoryMock.save(any(UsersEntity.class))).thenReturn(new UsersEntity());
        usersServiceTest.initUsers();
        verify(cartsRepositoryMock, times(5)).save(any(CartEntity.class));
        verify(usersRepositoryMock, times(5)).save(any(UsersEntity.class));
